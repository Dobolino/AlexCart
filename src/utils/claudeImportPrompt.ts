...
- Schema:
{
  "week": "YYYY-MM-DD",
  "items": [
    { "name": "Produktname", "amount": "Menge mit Einheit", "category": "Kategorie" }
  ]
}
...
- "amount": Menge + Einheit als ein String (siehe Mengenregeln unten).
...
3. Keine Rezept-Mengen wie "eine Prise", "nach Geschmack", "etwas". Lieber weglassen oder sinnvolle Kaufmenge wählen.
4. Keine doppelten Artikel: gleiche name+category zusammenfassen und Mengen addieren (z. B. 2× Milch → "2 l").
5. Keine Vorratsschrank-Dinge die man typischerweise schon hat (Salz, Pfeffer), es sei denn der Plan verlangt explizit Nachkauf.
6. amount darf leer sein nur wenn die Menge völlig unklar ist – sonst immer setzen.

BEISPIELE (gut)
{"week":"2026-08-10","items":[
  {"name":"Skyr","amount":"2 Becher","category":"Milch & Käse"},
  {"name":"Tomaten","amount":"500 g","category":"Früchte & Gemüse"},
  {"name":"Gurken","amount":"2 Stück","category":"Früchte & Gemüse"},
  {"name":"Hähnchenbrust","amount":"600 g","category":"Fleisch & Fisch"},
  {"name":"Reis","amount":"1 Packung","category":"Getreide & Beilagen"},
  {"name":"Passata","amount":"2 Dosen","category":"Konserven & Saucen"},
  {"name":"Milch","amount":"2 l","category":"Milch & Käse"}
]}
